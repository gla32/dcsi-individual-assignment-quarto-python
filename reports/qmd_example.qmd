...
pandas (McKinney 2010)@pandas , alair (VanderPlas 2018)@altair, click (Team 2020), 
...
Additionally, note that in @tbl-horsepopulation we consider the sample standard deviation of the number of horses during the same time span as @fig-Figure1.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-Figure2 width="70%"}

In @fig-Figure2 we zoom in and look at the province of `{python} province_name`, which had the largest spread of values in terms of standard deviation.
